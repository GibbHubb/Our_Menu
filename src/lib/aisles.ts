...
const RULES: Array<[Aisle, string[]]> = [
    ...
    ["cupboard", ["flour", "sugar", "rice", "pasta", "spaghetti", "noodle", "lentil", "chickpea",
        "bean", "butter bean", "cannellini", "borlotti", "kidney bean", "tin", "can",
        "tomato paste", "passata", "stock", "broth", "oil", "olive oil",
        // a stock is a cupboard item, not a trip to the butcher: these must
        // outrank "chicken" and "beef" in the meat list.
        "chicken stock", "beef stock", "vegetable stock", "fish stock", "chicken broth",
        "beef broth", "stock powder", "bouillon",
    ...
    ["spices", ["salt", "black pepper", "white pepper", "peppercorn", "cracked pepper", "paprika", "cumin", "coriander powder", "turmeric", "cinnamon",
        ...
        "onion powder", "garlic powder", "ginger powder", "chipotle", "cayenne",
        "smoked paprika", "chilli flakes", "italian herbs", "herbes de provence"]],
    ["frozen", ["frozen", "ice cream", "peas frozen", "puff pastry frozen"]],
    ["drinks", ["wine", "beer", "stock cube", "coffee", "tea", "limoncello", "vodka",
